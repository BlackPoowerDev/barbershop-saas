import {getUsers,createUsers, deleteUsers,getUser,updateUser} from '../controllers/users.js'
...
routerUsers.get('/', authorize(['administrador']), async (req, res) =>{
...
routerUsers.get('/:id', authorize(['administrador']), async (req, res) =>{
...
routerUsers.delete('/:id', authorize(['administrador']), async (req, res) =>{
...
routerUsers.patch('/:id', authorize(['administrador']), async (req, res) =>{
